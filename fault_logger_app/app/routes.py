...
from app.forms import RegistrationForm, LoginForm, UpdateAccountForm, MotorForm, FunctionForm, FaultForm, SearchForm, LocationForm
...
def search():
    ...
    motors = Motors.query.filter_by(serial_number=motor).first()
